...
export default class ConsoleReporter extends Reporter {
  ...
  //print helpers
  [printError](error) {
    console.log(this.formatTaskError(error));
  }
  ...
  [printSimpleResult](state, title, time) {
    console.print(this[buildSimpleResult](state, title, time));
  }

  [logSimpleResult](state, title, time) {
    console.log(this[buildSimpleResult](state, title, time));
  }

  [logCompositeResult](title) {
    console.log(this.formatCompositeTaskTitle(title));
  }
}
