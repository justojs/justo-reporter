//imports
import {ResultState, Result, SimpleTaskResult, MacroResult, WorkflowResult} from "justo-result";
...
export default class Reporter {
  ...
  ignore(title, task) {
    ...
    else if (task.isMacro()) res = new MacroResult(parent, title, task, ResultState.IGNORED);
    else if (task.isWorkflow()) res = new WorkflowResult(parent, title, task, ResultState.IGNORED);
    else throw new Error("Invalid type of task.");
  ...
  [startTask](title, task) {
    ...
    else if (task.isMacro()) res = new MacroResult(parent, title, task);
    else if (task.isWorkflow()) res = new WorkflowResult(parent, title, task);
    else throw new Error("Invalid type of task.");
