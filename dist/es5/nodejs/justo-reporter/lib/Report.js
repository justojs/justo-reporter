...
Report = function () {
  ...
  function Report(title) {_classCallCheck(this, Report);
    ...
    Object.defineProperty(this, "results", { value: new _justoResult.Results() });
  }_createClass(Report, [{ key: "add", value: function add(
    ...
    } }, { key: "getNumberOf", value: function getNumberOf(
    ...
    } }, { key: "length", get: function get() {return this.results.length;} }]);return Report;}();exports.default = Report;
