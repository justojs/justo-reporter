...
ColoredConsoleReporter = function (_ConsoleReporter) {_inherits(ColoredConsoleReporter, _ConsoleReporter);function ColoredConsoleReporter() {_classCallCheck(this, ColoredConsoleReporter);return _possibleConstructorReturn(this, (ColoredConsoleReporter.__proto__ || Object.getPrototypeOf(ColoredConsoleReporter)).apply(this, arguments));}_createClass(ColoredConsoleReporter, [{ key: "getDefaultTheme", value: function getDefaultTheme()
    ...
    {
      return _colors2.default[this.theme.task.result.ok.color]("OK");
    ...
    {
      return _colors2.default[this.theme.task.result.failed.color]("Failed");
    ...
    {
      return _colors2.default[this.theme.task.result.ignored.color]("Ignored");
    ...
    title) {
      return _colors2.default[this.theme.header.title.color](title);
    ...
    title) {
      return _colors2.default[this.theme.task.title.simple](title);
    ...
    title) {
      return _colors2.default[this.theme.task.title.composite](title);
    ...
    state) {
      ...
      return _colors2.default[this.theme.task.result[state].color](this.theme.task.result[state].text);
    ...
    time) {
      return _colors2.default.gray("(" + time + " ms)");
    ...
    err) {
      return _colors2.default[this.theme.task.result.failed.color](_get(ColoredConsoleReporter.prototype.__proto__ || Object.getPrototypeOf(ColoredConsoleReporter.prototype), "formatTaskError", this).call(this, err));
    } }], [{ key: "DEFAULT_THEME", get: function get() {return DEFAULT_THEME;} }]);return ColoredConsoleReporter;}(_ConsoleReporter3.default);exports.default = ColoredConsoleReporter;
