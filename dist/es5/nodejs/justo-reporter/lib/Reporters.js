...
Reporters = function () {
  ...
  function Reporters() {_classCallCheck(this, Reporters);
    ...
    Object.defineProperty(this, "ignore", { value: Reporters.prototype.ignore });}_createClass(Reporters, [{ key: "add", value: function add(
    ...
    {var _iteratorNormalCompletion2 = true;var _didIteratorError2 = false;var _iteratorError2 = undefined;try {
        for (var _iterator2 = this.items[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {var rep = _step2.value;rep.start.apply(rep, arguments);}} catch (err) {_didIteratorError2 = true;_iteratorError2 = err;} finally {try {if (!_iteratorNormalCompletion2 && _iterator2.return) {_iterator2.return();}} finally {if (_didIteratorError2) {throw _iteratorError2;}}}} }, { key: "end", value: function end() 
